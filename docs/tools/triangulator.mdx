...
Given the two pairs of points, the tool creates a vector for each point, $\vec{P_1}$, $\vec{Q_1}$, $\vec{P_2}$, and $\vec{Q_2}$.

To calculate a line crossing two points, $\vec{P}$ and $\vec{Q}$, given $\vec{D}$ as the direction vector, we can use the following parametric equation:

$$
\vec{r} = \vec{P} + t\vec{D}
$$

Since the direction can be expressed as the difference between the two points, i.e. $\vec{D} = \vec{Q} - \vec{P}$, we can simplify the equation to:
...
$$
\begin{align*}
    \vec{r_1} &= \vec{P_1} + t_1(\vec{Q_1} - \vec{P_1}) &= \begin{bmatrix} (\vec{P_1})_0 \\ (\vec{P_1})_1 \\ \vdots{} \\ \vec{(P_1)_n} \end{bmatrix} + t_1\begin{bmatrix} (\vec{Q_1})_0 - (\vec{P_1})_0 \\ (\vec{Q_1})_1 - (\vec{P_1})_1 \\ \vdots{} \\ \vec{(Q_1)_n} - \vec{(P_1)_n} \end{bmatrix} \\
    \vec{r_2} &= \vec{P_2} + t_2(\vec{Q_2} - \vec{P_2}) &= \begin{bmatrix} (\vec{P_2})_0 \\ (\vec{P_2})_1 \\ \vdots{} \\ \vec{(P_2)_n} \end{bmatrix} + t_2\begin{bmatrix} (\vec{Q_2})_0 - (\vec{P_2})_0 \\ (\vec{Q_2})_1 - (\vec{P_2})_1 \\ \vdots{} \\ \vec{(Q_2)_n} - \vec{(P_2)_n} \end{bmatrix}
\end{align*}
$$
...
$$
\vec{P_1} + t_1(\vec{Q_1} - \vec{P_1}) = \vec{P_2} + t_2(\vec{Q_2} - \vec{P_2})
$$
...
$$
\begin{cases}
    (\vec{P_1})_0 + t_1((\vec{Q_1})_0 - (\vec{P_1})_0) &= (\vec{P_2})_0 + t_2((\vec{Q_2})_0 - (\vec{P_2})_0) \\
    (\vec{P_1})_1 + t_1((\vec{Q_1})_1 - (\vec{P_1})_1) &= (\vec{P_2})_1 + t_2((\vec{Q_2})_1 - (\vec{P_2})_1) \\
    &\vdots{} \\
    \vec{(P_1)_n} + t_1(\vec{(Q_1)_n} - \vec{(P_1)_n}) &= \vec{(P_2)_n} + t_2(\vec{(Q_2)_n} - \vec{(P_2)_n})
\end{cases}
$$
...
\begin{align*}
    a &= (\vec{P_1})_0 \\
    b &= (\vec{Q_1})_0 - (\vec{P_1})_0 \\
    c &= (\vec{P_2})_0 \\
    d &= (\vec{Q_2})_0 - (\vec{P_2})_0 \\
    e &= (\vec{P_1})_1 \\
    f &= (\vec{Q_1})_1 - (\vec{P_1})_1 \\
    g &= (\vec{P_2})_1 \\
    h &= (\vec{Q_2})_1 - (\vec{P_2})_1
\end{align*}
$$
...
\begin{align*}
    t_1 &= \frac{
                ((\vec{Q_2})_0 - (\vec{P_2})_0)((\vec{P_2})_1 - (\vec{P_1})_1)
                + ((\vec{Q_2})_1 - (\vec{P_2})_1)((\vec{P_1})_0 - (\vec{P_2})_0)
            }{
                ((\vec{Q_2})_0 - (\vec{P_2})_0)((\vec{Q_1})_1 - (\vec{P_1})_1)
                - ((\vec{Q_1})_0 - (\vec{P_1})_0)((\vec{Q_2})_1 - (\vec{P_2})_1)
            } \\
        &= \frac{
                ((\vec{Q_2})_0)((\vec{P_2})_1) - ((\vec{Q_2})_0)((\vec{P_1})_1)
                - ((\vec{P_2})_0)((\vec{P_2})_1) + ((\vec{P_2})_0)((\vec{P_1})_1)
                + ((\vec{Q_2})_1)((\vec{P_1})_0) - ((\vec{Q_2})_1)((\vec{P_2})_0)
                - ((\vec{P_2})_1)((\vec{P_1})_0) + ((\vec{P_2})_1)((\vec{P_2})_0)
            }{
                ((\vec{Q_2})_0)((\vec{Q_1})_1) - ((\vec{Q_2})_0)((\vec{P_1})_1)
                - ((\vec{P_2})_0)((\vec{Q_1})_1) + ((\vec{P_2})_0)((\vec{P_1})_1)
                + ((\vec{Q_1})_0)((\vec{Q_2})_1) - ((\vec{Q_1})_0)((\vec{P_2})_1)
                - ((\vec{P_1})_0)((\vec{Q_2})_1) + ((\vec{P_1})_0)((\vec{P_2})_1)
            } \\
    t_2 &= \frac{
                ((\vec{Q_1})_0 - (\vec{P_1})_0)((\vec{P_2})_1 - (\vec{P_1})_1)
                - ((\vec{Q_1})_1 - (\vec{P_1})_1)((\vec{P_1})_0 - (\vec{P_2})_0)
            }{
                ((\vec{Q_2})_0 - (\vec{P_2})_0)((\vec{Q_1})_1 - (\vec{P_1})_1)
                - ((\vec{Q_1})_0 - (\vec{P_1})_0)((\vec{Q_2})_1 - (\vec{P_2})_1)
            } \\
        &= \frac{
                ((\vec{Q_1})_0)((\vec{P_2})_1) - ((\vec{Q_1})_0)((\vec{P_1})_1)
                - ((\vec{P_1})_0)((\vec{P_2})_1) + ((\vec{P_1})_0)((\vec{P_1})_1)
                - ((\vec{Q_1})_1)((\vec{P_1})_0) + ((\vec{Q_1})_1)((\vec{P_2})_0)
                + ((\vec{P_1})_1)((\vec{P_1})_0) - ((\vec{P_1})_1)((\vec{P_2})_0)
            }{
                ((\vec{Q_2})_0)((\vec{Q_1})_1) - ((\vec{Q_2})_0)((\vec{P_1})_1)
                - ((\vec{P_2})_0)((\vec{Q_1})_1) + ((\vec{P_2})_0)((\vec{P_1})_1)
                + ((\vec{Q_1})_0)((\vec{Q_2})_1) - ((\vec{Q_1})_0)((\vec{P_2})_1)
