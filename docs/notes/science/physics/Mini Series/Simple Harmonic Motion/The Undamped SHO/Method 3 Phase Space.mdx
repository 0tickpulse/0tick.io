...
In this section, we will explore the third method of solving this differential equation: transforming it into a system of first-order ODEs and then using linear algebra to solve it.
...
This is known as a **phase space**.
...
In that case, the solution is $y(t) = C e^{k(t + \phi)}$.
