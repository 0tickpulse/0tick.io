...
export function CombinedElectricFields({ added = false, smooth = false }) {
    ...
    const parametricTotalAcceleration = (t, x, y) => {
        ...
        console.log({ key, parametricTotalAccelerationCache })
    ...
    return (
        <>
            ...
            >
                ...
                {added && (() => {
                    const vectorField = <Plot.VectorField xy={totalAcceleration} step={1} xyOpacity={() => smooth ? 0.5 : 1} color={Theme.blue} />;
                    if (!smooth) {
                        return vectorField;
                    }
                    ...
                    return points.map((point) => {
                        ...
                        return <Circle center={newPoint} radius={0.05} fillOpacity={0.5} color={Theme.blue} />;
                    }).concat(vectorField);
                })()}
