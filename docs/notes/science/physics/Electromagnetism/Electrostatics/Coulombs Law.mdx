...
There is a far better way to do this, and that is by using Gauss' Law.
In fact, Gauss' Law is so powerful that a person could probably solve this problem completely mentally.
We shall discuss Gauss' Law in the next section.
