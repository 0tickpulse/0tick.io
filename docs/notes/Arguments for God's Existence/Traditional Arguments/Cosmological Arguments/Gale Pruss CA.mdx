...
## The Big Conjunctive Contingent Proposition

The second premise posits the existence of a Big Conjunctive Contingent Proposition (BCCP) that includes all contingent truths in the actual world.

The previous section on the Pruss formulation of the Leibnizian cosmological argument already discussed how Tomaszewski's argument shows that it is impossible for something like the BCCP to exist.
...
- Compossible means that the propositions can all be true at the same time.
    More concretely, it means that they do not contradict each other.
...
In other words, the BCF must have an explanation in the same world and hence entails the strong PSR.
