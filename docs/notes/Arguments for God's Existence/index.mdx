...
This whole discussion is based on Capturing Christianity's video series on the arguments for God's existence, as well as Joe Schmid's commentary on the same series.
