...
Because $e^{i\omega x}$ is an eigenfunction of the momentum operator, this integral resembles a spectral decomposition of the position wavefunction in terms of momentum eigenfunctions:
