...
These operators are denoted by a hat, such as $\hat{x}$, $\hat{p}$, $\hat{E}$, and so on, although we will eventually drop the hat.
*The operators lose their hats!*
...
(We will take a similar approach when discussing the Schrödinger equation, which is another postulate, but still has a physical basis.
        ...
        <div className="card">
            <div className="card__body">
                <Mafs viewBox={{ y: [-1, 1] }}>
                    ...
                    <MafsMathJax tex="\ket{E_1}" at={[1.2, 0]} color={color("blue")} />
                    <Vector tip={[0, 1]} color={color("blue")} />
                    <MafsMathJax tex="\ket{E_2}" at={[0, 1.2]} color={color("blue")} />

                    <Vector tip={psi.point} color={color("yellow")} />
                    <MafsMathJax tex="\ket{\psi}" at={vec.withMag(psi.point, 1.2)} color={color("yellow")} />
                    {psi.element}

                    <Polyline points={[[0, 0], [psi.point[0], 0], psi.point]} strokeStyle="dashed" />
                    <MafsMathJax tex={psi.point[1].toFixed(2)} at={[psi.point[0] + (psi.point[0] > 0 ? 0.2 : -0.2), psi.point[1] / 2]} />
                    <MafsMathJax tex={psi.point[0].toFixed(2)} at={[psi.point[0] / 2, (psi.point[1] > 0 ? -0.2 : 0.2)]} />
                </Mafs>
            </div>
