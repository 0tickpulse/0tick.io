...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            $$
            \begin{align}
            \mathcal{F}[f(x)] &= \tilde{f}(\omega) = \frac{1}{\sqrt{2\pi}} \int_{-\infty}^{\infty} \dd{x} e^{-i\omega x} f(x) \\
            \mathcal{F}^{-1}[\tilde{f}(\omega)] &= f(x) = \frac{1}{\sqrt{2\pi}} \int_{-\infty}^{\infty} \dd{\omega} e^{i\omega x} \tilde{f}(\omega)
            \end{align}
            $$
    ...
    <tbody>
        ...
        <tr>
            ...
            [Derivations](http://localhost:3000/notes/QFT%20from%20Ground%20Up/Part%20I%20Quantum%20Mechanics/Mathematical%20Foundations/Observables%20and%20Operators#properties-of-hermitian-adjoint),
            [derivation of last property](./http://localhost:3000/notes/QFT%20from%20Ground%20Up/Part%20I%20Quantum%20Mechanics/Mathematical%20Foundations/Observables%20and%20Operators#appendix-why-is-the-hermitian-adjoint-of-a-ket-its-corresponding-bra).
            </td>
            <td>
