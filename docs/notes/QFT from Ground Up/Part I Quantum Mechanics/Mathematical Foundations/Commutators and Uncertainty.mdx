...
Sometimes, the Uncertainty Principle is derived from Fourier analysis, which deserves its own discussion.
...
$$
\begin{equation}
\qty[\hat{A}, \hat{B}] := \hat{A}\hat{B} - \hat{B}\hat{A} \label{eq:commutator}
\end{equation}
$$

If both operators commute, then $[\hat{A}, \hat{B}] = 0$, just like in classical mechanics.
...
$$
\begin{equation}
\qty{\hat{A}, \hat{B}} := \hat{A}\hat{B} + \hat{B}\hat{A} \label{eq:anticommutator}
\end{equation}
$$
...
$$
\begin{equation}
\hat{A}\hat{B} = \frac{1}{2} (\hat{A}\hat{B} + \hat{B}\hat{A}) + \frac{1}{2} (\hat{A}\hat{B} - \hat{B}\hat{A}) = \frac{1}{2} \qty{\hat{A}, \hat{B}} + \frac{1}{2} \qty[\hat{A}, \hat{B}] \label{eq:commutator-anticommutator}
\end{equation}
$$
...
$$
\begin{equation}
\qty[\hat{A}, \hat{B}]^\dagger = \qty(\hat{A}\hat{B} - \hat{B}\hat{A})^\dagger = \hat{B}^\dagger\hat{A}^\dagger - \hat{A}^\dagger\hat{B}^\dagger
\end{equation}
$$
...
$$
\begin{equation}
\qty[\hat{A}, \hat{B}]^\dagger = \hat{B}\hat{A} - \hat{A}\hat{B} = -\qty[\hat{A}, \hat{B}]
\end{equation}
$$
...
$$
\begin{equation}
\qty{\hat{A}, \hat{B}}^\dagger = \qty(\hat{A}\hat{B} + \hat{B}\hat{A})^\dagger = \hat{B}^\dagger\hat{A}^\dagger + \hat{A}^\dagger\hat{B}^\dagger = \hat{B}\hat{A} + \hat{A}\hat{B} = \qty{\hat{A}, \hat{B}}
\end{equation}
$$
...
$$
\begin{equation}
\Delta \hat{A}\Delta \hat{B} = \frac{1}{2} \qty{\Delta \hat{A}, \Delta \hat{B}} + \frac{1}{2} \qty[\Delta \hat{A}, \Delta \hat{B}]
\end{equation}
$$
...
$$
\begin{equation}
\expval{\Delta \hat{A}\Delta \hat{B}} = \frac{1}{2} \expval{\qty{\Delta \hat{A}, \Delta \hat{B}}} + \frac{1}{2} \expval{\qty[\Delta \hat{A}, \Delta \hat{B}]}
\end{equation}
$$
...
As such, the expectation value of $\qty[\Delta \hat{A}, \Delta \hat{B}]$ is imaginary, and the expectation value of $\qty{\Delta \hat{A}, \Delta \hat{B}}$ is real.
Hence, the square of the magnitude of the expectation value of the commutator is:

$$
\begin{equation}
\abs{\expval{\Delta \hat{A}\Delta \hat{B}}}^2 = \frac{1}{4} \abs{\expval{\qty{\Delta \hat{A}, \Delta \hat{B}}}}^2 + \frac{1}{4} \abs{\expval{\qty[\Delta \hat{A}, \Delta \hat{B}]}^2}
\end{equation}
$$

The commutator $\qty[\Delta \hat{A}, \Delta \hat{B}]$ is simply equal to $\qty[\hat{A}, \hat{B}]$.
(To see this, expand $\Delta \hat{A}$ and $\Delta \hat{B}$ in terms of $\hat{A}$ and $\hat{B}$, and then subtract them.)
Thus:

$$
\begin{equation}
\abs{\expval{\Delta \hat{A}\Delta \hat{B}}}^2 = \frac{1}{4} \abs{\expval{\qty{\Delta \hat{A}, \Delta \hat{B}}}^2} + \frac{1}{4} \abs{\expval{\qty[\hat{A}, \hat{B}]}^2}
\end{equation}
$$
...
$$
\begin{equation}
\frac{1}{4} \abs{\expval{\qty{\Delta \hat{A}, \Delta \hat{B}}}^2} + \frac{1}{4} \abs{\expval{\qty[\hat{A}, \hat{B}]}^2} \leq \expval{(\Delta \hat{A})^2} \expval{(\Delta \hat{B})^2}
\end{equation}
$$
...
$$
\begin{equation}
\frac{1}{4} \abs{\expval{\qty[\hat{A}, \hat{B}]}^2} \leq \expval{(\Delta \hat{A})^2} \expval{(\Delta \hat{B})^2} \tag{\ref{eq:uncertainty-principle}}
\end{equation}
$$
...
- The commutator in quantum mechanics is defined as:
    ...
    $$
    \begin{equation}
    \qty[\hat{A}, \hat{B}] := \hat{A}\hat{B} - \hat{B}\hat{A} \tag{\ref{eq:commutator}}
    \end{equation}
    $$
...
- The anti-commutator in quantum mechanics is defined as:
    ...
    $$
    \begin{equation}
    \qty{\hat{A}, \hat{B}} := \hat{A}\hat{B} + \hat{B}\hat{A} \tag{\ref{eq:anticommutator}}
    \end{equation}
    $$
...
- The composition of the commutator and anti-commutator is:
    ...
    $$
    \begin{equation}
    \hat{A}\hat{B} = \frac{1}{2} \qty{\hat{A}, \hat{B}} + \frac{1}{2} \qty[\hat{A}, \hat{B}] \tag{\ref{eq:commutator-anticommutator}}
    \end{equation}
    $$
...
- The Uncertainty Principle states:
    ...
    $$
    \begin{equation}
    \expval{(\Delta \hat{A})^2} \expval{(\Delta \hat{B})^2} \geq \frac{1}{4} \abs{\expval{[\hat{A}, \hat{B}]}^2} \tag{\ref{eq:uncertainty-principle}}
    \end{equation}
    $$
