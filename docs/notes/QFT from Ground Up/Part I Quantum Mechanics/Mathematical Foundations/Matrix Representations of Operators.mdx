...
This action is known as the tensor product, denoted by $\otimes$.
...
Tensor products will definitely show up later in the course. For instance, the vector space of a system of two particles is the tensor product of the vector spaces of the individual particles.
