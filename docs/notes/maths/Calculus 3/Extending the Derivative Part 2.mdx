...
Essentially you add up the second partial derivatives of the components of the vector field:

$$
\begin{equation}
\operatorname{Lap} \va{F}(x, y) = \pdv[2]{P}{x} + \pdv[2]{Q}{y} + \pdv[2]{R}{z}
\end{equation}
$$
...
$$
\begin{equation}
\operatorname{Lap} \va{F}(x, y, z) = \sum_i \pdv[2]{F_i}{x_i}
\end{equation}
$$
...
\begin{equation}
\begin{split}
\operatorname{Lap} \va{F}(x, y) &= \pdv{x} \pdv{P}{x} + \pdv{y} \pdv{Q}{y} + \pdv{z} \pdv{R}{z} \\
&= \operatorname{div} \mqty[\pdv{P}{x} \\ \pdv{Q}{y} \\ \pdv{R}{z}] \\
\end{split}
\end{equation}
$$
