...
This isn't actually the formal definition of divergence.
The formal definition looks a bit more complicated:

$$
\begin{equation}
\operatorname{div} \va{F}(x, y) = \lim_{{\Delta V \to 0}} \frac{1}{\Delta V} \iint_S \va{F} \cdot \vu{n} \dd{\Sigma}
\end{equation}
$$

Don't worry about this for now. This is just to show that the concept of divergence is more general than what we've discussed;
it is a universal definition for all coordinate systems and dimensions.
