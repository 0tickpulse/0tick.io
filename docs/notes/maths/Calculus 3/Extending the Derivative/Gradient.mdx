...
There is an optional section afterwards that explores the gradient in other coordinate systems, including cylindrical and spherical coordinates.
Otherwise, the next section is on the directional derivative.
