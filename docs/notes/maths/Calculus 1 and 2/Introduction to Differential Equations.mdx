...
- **Solving DEs** - Solve the DE using various methods, such as separation of variables, substitution, and partial fractions.
- **Interpreting DEs** - Understand the properties of the DE to gain an intuitive understanding of the system.

Since many DEs cannot be solved analytically, numerical methods, such as Euler's method, are used to approximate the solution.
