...
- I avoid using the notation $f'(x)$ (called "Lagrange's notation") in these notes, and instead use $\frac{d}{dx}f(x)$ (called "Leibniz notation"). This is because Lagrange's notation is ambiguous and can be confusing, especially when dealing with higher derivatives and variable naming. Leibniz notation is more precise and easier to work with, especially when dealing with multiple variables.
