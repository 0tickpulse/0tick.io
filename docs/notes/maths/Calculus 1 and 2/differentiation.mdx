...
export function SimpleProducts() {
    ...
    return (<>
        ...
        <div>
            <ControlPanel>
                <SliderInput latex label="x" value={x} min={0} max={7} step={0.1} onChange={setX} />
            </ControlPanel>
        </div>
    </>)
    ...
    return (
        <div className="card">
            ...
            <div className="card__footer">
                <ControlPanel>
                    <SliderInput latex label="x" value={x} min={3} max={7} step={0.1} onChange={setX} />
                </ControlPanel>
            </div>
        </div>
    )
