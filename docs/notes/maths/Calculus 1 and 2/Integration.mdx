...
$$
\begin{equation}
\text{Average} = \frac{\int_{T_0}^{T_1} v(t) \dd{t}}{T_1 - T_0} = \frac{s(T_1) - s(T_0)}{T_1 - T_0}
\end{equation}
$$
...
$$
\begin{equation}
\int \frac{1}{\sqrt{a^2 - x^2}}\class{blue}\dd{x} = \int \frac{\class{blue}{a \cos(\theta)}}{\sqrt{a^2 - x^2}}\class{blue}{d\theta}
\end{equation}
$$
...
$$
\begin{equation}
\int \frac{1}{\class{red}{a}^2 \sec^2(\theta)} \class{blue}\dd{x} = \int \frac{\class{blue}{a \cancel{\sec^2(\theta)}}}{\class{red}{a}^2 \cancel{\sec^2(\theta)}} \class{blue}{d\theta} = \frac{1}{\class{red}{a}} \theta + C
\end{equation}
$$
...
$$
\begin{equation}
\int \frac{1}{\class{red}{a}^2 + \class{yellow}{x}^2} dx = \frac{1}{\class{red}{a}}\arctan\qty(\frac{\class{yellow}{x}}{\class{red}{a}}) + C
\end{equation}
$$
...
$$
\begin{align}
\int \frac{1}{\sqrt{3 - 2x^2}} dx &= \int \frac{1}{\sqrt{3\cos^2(\theta)}} \class{yellow}\dd{x} \\
...
$$
\begin{equation}
\int \frac{1}{\sqrt{3 - 2x^2}} dx = \frac{1}{\sqrt{2}} \theta + C = \frac{1}{\sqrt{2}} \arcsin\qty(\sqrt{\frac{2}{3}}x) + C
\end{equation}
$$
...
$$
\begin{align}
\int \class{red}{x^3} \class{blue}{\sqrt{9 - x^2}} \class{green}\dd{x} &= \int \class{red}{27\sin^3(\theta)} \class{blue}{3\cos(\theta)} \class{green}{3\cos(\theta) d\theta} \\
...
Here, if we let $-\sin(\theta) d\theta$ be $\dd{u}$, then we need to make $u = \cos(\theta)$. To do so, we can make use of the Pythagorean identity once again:
...
&= -243 \int (u^2 - u^4) du \\
&= -243 \qty(\frac{u^3}{3} - \frac{u^5}{5}) + C \label{eq:example_problem_combining_u_and_trigonometric_substitution-answer-u}
\end{align}
$$
...
$$
\begin{align}
\int x^3 \sqrt{9 - x^2} dx = \dots &= -243 \qty(\frac{u^3}{3} - \frac{u^5}{5}) + C \\
...
- **Trigonometric substitution** is used to substitute trigonometric functions to simplify the integrand:
    $$
    \begin{align}
    \int \frac{1}{\sqrt{a^2 - x^2}} dx &= \arcsin\qty(\frac{x}{a}) + C \\
    \int \frac{1}{a^2 + x^2} dx &= \frac{1}{a}\arctan\qty(\frac{x}{a}) + C
    \end{align}
    $$
