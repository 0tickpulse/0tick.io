...
$$
\int\limits_{x = 0}^{x = \pi} \frac{4x}{x^2 + 5} dx = \int\limits_{x = 0}^{x = \pi} \frac{2}{\ln(u)} du = \int\limits_{u = 5}^{u = \pi^2 + 5} \frac{2}{\ln(u)} du
$$
...
$$
\begin{equation}
\int \frac{1}{\sqrt{a^2 - x^2}}dx \label{eq:trigonometric_substitution_with_sine-first}
\end{equation}
$$
...
Through the Pythagorean Theorem, the red line is $\sqrt{a^2 - x^2}$, which is the denominator of the expression in Equation $\ref{eq:trigonometric_substitution_with_sine-first}$.
...
$$
\begin{equation}
d\class{yellow}{x} = \class{green}{a} \cos(\theta) d\theta \label{eq:trigonometric_substitution_with_sine-first-dx-def}
\end{equation}
$$

Take the original integral $\ref{eq:trigonometric_substitution_with_sine-first}$ and substitute Equation $\ref{eq:trigonometric_substitution_with_sine-first-dx-def}$ into it:

$$
\begin{equation}
\int \frac{1}{\sqrt{a^2 - x^2}}\class{blue}{dx} = \int \frac{\class{blue}{a \cos(\theta)}}{\sqrt{a^2 - x^2}}\class{blue}{d\theta}
\end{equation}
$$

Then, substitute $\ref{eq:trigonometric_substitution_with_sine-first-radical-def}$ into it:

$$
\begin{align}
\int \frac{a \cos(\theta)}{\class{red}{\sqrt{a^2 - x^2}}}d\theta &= \int \frac{\cancel{a \cos(\theta)}}{\class{red}{\cancel{a \cos(\theta)}}}d\theta \\
&= \int d\theta = \theta + C
\end{align}
$$

We can solve Equation $\ref{eq:trigonometric_substitution_with_sine-first-x-def}$ for $\theta$ in terms of $\class{yellow}{x}$:

$$
\begin{align}
\sin(\theta) &= \frac{\class{yellow}{x}}{\class{green}{a}} \\
\theta &= \arcsin\left(\frac{\class{yellow}{x}}{\class{green}{a}} \right)
\end{align}
$$
...
Another way to derive Equation $\ref{eq:trigonometric_substitution_with_sine-first-radical-def}$ through the Pythagorean Identity:
...
$$
\begin{equation}
\int \frac{1}{a^2 + x^2} dx \label{eq:trigonometric_substitution_with_tangent-first}
\end{equation}
$$
...
\theta &= \arctan\left(\frac{\class{yellow}{x}}{\class{red}{a}}\right) \label{eq:trigonometric_substitution_with_tangent-first-theta-def} \\
d\class{yellow}{x} &= \class{red}{a} \sec^2(\theta) d\theta \label{eq:trigonometric_substitution_with_tangent-first-dx-def}
\end{align}
$$
...
We can substitute this back into $\ref{eq:trigonometric_substitution_with_tangent-first}$:

$$
\begin{equation}
\int \frac{1}{\class{red}{a}^2 + \class{yellow}{x}^2} dx = \int \frac{1}{\class{red}{a}^2 \sec^2(\theta)} dx
\end{equation}
$$

Now substitute $\ref{eq:trigonometric_substitution_with_tangent-first-dx-def}$ into it:

$$
\begin{equation}
\int \frac{1}{\class{red}{a}^2 \sec^2(\theta)} \class{blue}{dx} = \int \frac{\class{blue}{a \cancel{\sec^2(\theta)}}}{\class{red}{a}^2 \cancel{\sec^2(\theta)}} \class{blue}{d\theta} = \frac{1}{\class{red}{a}} \theta + C
\end{equation}
$$

Finally, substitute $\ref{eq:trigonometric_substitution_with_tangent-first-theta-def}$:

$$
\begin{equation}
\int \frac{1}{\class{red}{a}^2 + \class{yellow}{x}^2} dx = \frac{1}{\class{red}{a}}\arctan\left(\frac{\class{yellow}{x}}{\class{red}{a}}\right) + C
\end{equation}
$$
...
> $$
> \begin{equation}
> \int \frac{1}{\sqrt{3 - 2x^2}} dx \label{eq:example_problem_trigonometric_substitution_1/sqrt(3-2x2)}
> \end{equation}
> $$
...
$$
\begin{equation}
\int \frac{1}{\sqrt{3 - 2x^2}} dx = \int \frac{1}{\sqrt{2(3/2 - x^2)}} dx = \int \frac{1}{\sqrt{2(\sqrt{3/2}^2 - x^2)}} dx
\end{equation}
$$
...
dx &= \sqrt{\frac{3}{2}}\cos(\theta) d\theta \label{eq:example_problem_trigonometric_substitution_1/sqrt(3-2x2)-dx-def} \\
\theta &= \arcsin\left(\sqrt{\frac{2}{3}}x\right) \label{eq:example_problem_trigonometric_substitution_1/sqrt(3-2x2)-theta-def}
\end{align}
$$
...
$$
\begin{align}
2\left(\sqrt{\frac{3}{2}}^2 - x^2\right) &= 2\left(\frac{3}{2} - \frac{3}{2}\sin^2(\theta)\right) \\
&= 3(1 - \sin^2(\theta))
\end{align}
$$
...
Substituting this, along with Equation $\ref{eq:example_problem_trigonometric_substitution_1/sqrt(3-2x2)-dx-def}$ back into $\ref{eq:example_problem_trigonometric_substitution_1/sqrt(3-2x2)}$:

$$
\begin{align}
\int \frac{1}{\sqrt{3 - 2x^2}} dx &= \int \frac{1}{\sqrt{3\cos^2(\theta)}} \class{yellow}{dx} \\
&= \int \frac{\class{yellow}{\sqrt{3}/\sqrt{2} \cos(\theta)}}{\sqrt{3} \cos(\theta)} \class{yellow}{d\theta} \\
&= \int \frac{1}{\sqrt{2}} d\theta = \frac{1}{\sqrt{2}} \theta + C
\end{align}
$$

Substituting $\ref{eq:example_problem_trigonometric_substitution_1/sqrt(3-2x2)-theta-def}$:

$$
\begin{equation}
\int \frac{1}{\sqrt{3 - 2x^2}} dx = \frac{1}{\sqrt{2}} \theta + C = \frac{1}{\sqrt{2}} \arcsin\left(\sqrt{\frac{2}{3}}x\right) + C
\end{equation}
$$
...
$$
\begin{equation}
\int \frac{x - 5}{2x^2 - 5x + 3} dx \label{eq:integration_by_partial_fractions-original}
\end{equation}
$$
...
&= \frac{\class{red}{(2A + B)x} + \class{blue}{(-3A - B)}}{(x - 1)(2x - 3)} \label{eq:integration_by_partial_fractions-numerator}
\end{align}
$$

We now have two terms in the numerator, one with $x$ and one without $x$. Since all we did is rewrite the original fraction, we can equate the fraction in $\ref{eq:integration_by_partial_fractions-original}$ and $\ref{eq:integration_by_partial_fractions-numerator}$:
...
Substitute $A = 4$ and $B = -7$ back into $\ref{eq:integration_by_partial_fractions-split}$:

$$
\begin{align}
\int \frac{x - 5}{2x^2 - 5x + 3} dx &= \int \frac{4}{x - 1} - \frac{7}{2x - 3} dx \\
&= 4 \int \frac{1}{x - 1} dx - \frac{7}{2} \int \frac{2}{2x - 3} dx \\
\end{align}
$$
...
$$
\begin{align}
\int \overbrace{\boxed{\frac{1}{\class{red}{\underbrace{x - 1}_{g(x)}}}}}^{f'(g(x))} \class{blue}{\underbrace{dx}_{g'(x)}} &= f(g(x)) + C \\
&= \ln|x - 1| + C \\
\int \overbrace{\boxed{\frac{2}{\class{red}{\underbrace{2x - 3}_{g(x)}}}}}^{f'(g(x))} \class{blue}{\underbrace{dx}_{g'(x)}} &= f(g(x)) + C \\
&= \ln|2x - 3| + C
\end{align}
$$

Therefore, the integral at $\ref{eq:integration_by_partial_fractions-original}$ can be rewritten as:

$$
\begin{equation}
\int \frac{x - 5}{2x^2 - 5x + 3} dx = 4\ln|x - 1| - \frac{7}{2}\ln|2x - 3| + C
\end{equation}
$$
...
$$
\begin{align}
\int_1^{\infty} \frac{1}{x^2} dx = \lim_{n \to \infty} \int_1^n \frac{1}{x^2} dx &= \lim_{n \to \infty} \frac{x^{-1}}{-1} dx \\
&= \lim_{n \to \infty}\left(-\frac{1}{n} - \left(-\frac{1}{1}\right)\right) \\
&= \lim_{n \to \infty}\left(-\frac{1}{n} + 1\right) = 1
\end{align}
$$
...
$$
\begin{align}
\int_1^{\infty} \frac{1}{x} dx = \lim_{n \to \infty} \int_1^n \frac{1}{x} dx &= \lim_{n \to \infty} (\ln|n| - \ln|1|) \\
\end{align}
$$
...
> $$
> \begin{equation}
> \int x^3 \sqrt{9 - x^2} dx \label{eq:example_problem_combining_u_and_trigonometric_substitution-main}
> \end{equation}
> $$
...
\theta &= \arcsin\left(\frac{x}{3}\right) \label{eq:example_problem_combining_u_and_trigonometric_substitution-main-theta-def} \\
\sqrt{9 - x^2} &= \sqrt{9 - 9\sin^2(\theta)} \\
&= \sqrt{9(1 - \sin^2(\theta))} = 3\cos(\theta)
\end{align}
$$

Therefore, the integral at $\ref{eq:example_problem_combining_u_and_trigonometric_substitution-main}$ can be rewritten as:

$$
\begin{align}
\int \class{red}{x^3} \class{blue}{\sqrt{9 - x^2}} \class{green}{dx} &= \int \class{red}{27\sin^3(\theta)} \class{blue}{3\cos(\theta)} \class{green}{3\cos(\theta) d\theta} \\
&= \int 243 \sin^3(\theta) \cos^2(\theta) d\theta
\end{align}
$$
...
$$
\begin{equation}
\int 243 \sin^3(\theta) \cos^2(\theta) d\theta = 243 \int \sin^2(\theta) \cos^2(\theta) \sin(\theta) d\theta
\end{equation}
$$

Here, if we let $-\sin(\theta) d\theta$ be $du$, then we need to make $u = \cos(\theta)$. To do so, we can make use of the Pythagorean identity once again:

$$
\begin{equation}
243 \int \class{red}{\sin^2(\theta)} \cos^2(\theta) \sin(\theta) d\theta = 243 \int \class{red}{(1 - \cos^2(\theta))} \cos^2(\theta) \sin(\theta) d\theta
\end{equation}
$$
...
du &= -\sin(\theta) d\theta \\
243 \int (1 - \cos^2(\theta)) \cos^2(\theta) \sin(\theta) d\theta &= -243 \int \class{red}{(1 - \cos^2(\theta)) \cos^2(\theta)} \class{blue}{(-\sin(\theta)) d\theta} \\
&= -243 \int \class{red}{(1 - u^2)u^2} \class{blue}{du} \\
&= -243 \int (u^2 - u^4) du \\
&= -243 \left(\frac{u^3}{3} - \frac{u^5}{5}\right) + C \label{eq:example_problem_combining_u_and_trigonometric_substitution-answer-u}
\end{align}
$$

We can manipulate $\ref{eq:example_problem_combining_u_and_trigonometric_substitution-main-x-def}$ to derive an expression for $u$:
...
Finally, substituting this back into $\ref{eq:example_problem_combining_u_and_trigonometric_substitution-answer-u}$, and performing some algebra, we get the result:

$$
\begin{align}
\int x^3 \sqrt{9 - x^2} dx = \dots &= -243 \left(\frac{u^3}{3} - \frac{u^5}{5}\right) + C \\
&= -243 \left(\frac{\left(1 - \frac{x^2}{9}\right)^\frac{3}{2}}{3} - \frac{\left(1 - \frac{x^2}{9}\right)^\frac{5}{2}}{5}\right) + C \\
&= -243 \left(\frac{\frac{1}{9^{3/2}} \left(9 - x^2\right)^\frac{3}{2}}{3} - \frac{\frac{1}{9^{5/2}} \left(9 - x^2\right)^\frac{5}{2}}{5}\right) + C \\
&= -243 \left(\frac{\left(9 - x^2\right)^\frac{3}{2}}{3 \cdot 3^3} - \frac{\left(9 - x^2\right)^\frac{5}{2}}{5 \cdot 3^5} \right) + C \\
