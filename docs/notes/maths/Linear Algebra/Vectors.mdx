...
This, in turn, is the sum of the squares of the components of the cross product:

$$
\begin{align}
\norm{\va{v} \times \va{w}}^2 &= \class{blue}{(v_2w_3 - v_3w_2)^2} + \class{yellow}{(v_3w_1 - v_1w_3)^2} + \class{green}{(v_1w_2 - v_2w_1)^2} \\
&= \class{blue}{v_2^2w_3^2 - 2v_2w_2v_3w_3 + v_3^2w_2^2} + \class{yellow}{v_3^2w_1^2 - 2v_1w_1v_3w_3 + v_1^2w_3^2} + \class{green}{v_1^2w_2^2 - 2v_1w_1v_2w_2 + v_2^2w_1^2} \\
\end{align}
$$
